 ...
 */
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, classes = BibliotecaApplication.class)
@ActiveProfiles({"test"})
@Sql(scripts = {
        "classpath:/dbH2/01-truncate.sql",
        "classpath:/dbH2/02-insertIntoPersona.sql",
        "classpath:/dbH2/03-insertIntoUtente.sql",
        "classpath:/dbH2/04-insertIntoRuolo.sql",
        "classpath:/dbH2/05-insertIntoPersonale.sql",
        "classpath:/dbH2/06-insertIntoLibro.sql",
        "classpath:/dbH2/07-insertIntoPrenotazione.sql",
        "classpath:/dbH2/08-insertIntoMovimentoLibro.sql",
